...
public class JApps extends JFrame {
	...
	public JApps() {
		...
		btnNewButton.setIcon(new ImageIcon(JApps.class.getResource("/kapps/notepad.jpg")));
		...
		button.setIcon(new ImageIcon(JApps.class.getResource("/kapps/calculator.jpg")));
		...
		button_1.setIcon(new ImageIcon(JApps.class.getResource("/kapps/ip.jpg")));
		...
		button_2.setIcon(new ImageIcon(JApps.class.getResource("/kapps/tictactoe.jpg")));
		
		JButton button_3 = new JButton("");
		button_3.setIcon(new ImageIcon(JApps.class.getResource("/kapps/picturepuzzle.jpg")));
		...
		button_4.setIcon(new ImageIcon(JApps.class.getResource("/kapps/wct.jpg")));
		...
		button_5.setIcon(new ImageIcon(JApps.class.getResource("/kapps/Puzzle Game.jpg")));
		...
		button_6.setIcon(new ImageIcon(JApps.class.getResource("/kapps/Exam System.jpg")));
		...
		button_7.setIcon(new ImageIcon(JApps.class.getResource("/kapps/Source Code Generator.jpg")));
